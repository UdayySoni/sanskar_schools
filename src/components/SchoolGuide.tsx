...
export default function SchoolGuide() {
  return <section id="school-guide" className="bg-white py-16 lg:py-20" aria-labelledby="school-guide-title"><div className="container">
    <p className="eyebrow eyebrow-teal">Get to know Sanskar</p>
    <h2 id="school-guide-title" className="section-title mt-4 max-w-3xl">CBSE academics, admissions and campus visits</h2>
    ...
    <nav aria-label="Parent guides" className="mt-6 flex flex-wrap gap-x-7 gap-y-3 text-sm font-semibold text-blue">
      <Link to="/blog/choosing-best-school-in-mathura" className="underline underline-offset-4">How to choose a school in Mathura</Link>
      <Link to="/blog/top-10-schools-in-mathura-shortlist" className="underline underline-offset-4">Compare schools in Mathura</Link>
